  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <link rel="preconnect" href="/Hello.otf" />
        <meta
          name="description"
        ...
        <div className={styles.content}>
          <div className={styles.container}>
            <div className={styles.sky}>
              ...
              <h2 className={styles.text}>... and <b> Teh stars align </b></h2>
